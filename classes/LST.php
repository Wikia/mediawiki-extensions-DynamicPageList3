...
class LST {
	 ...
	 * @param string $link an optional link which will be appended to the text if it was truncatedt
	...
	public static function extractHeadingFromText( $parser, $page, $title, $text, &$sectionHeading, $recursionCheck = true, $maxLength = -1, $cLink = 'default', $trim = false, $skipPattern = [] ) {
		$continueSearch = true;
		$n              = 0;
		$output[$n]     = '';
		$nr             = 0;
	...
	public static function includeTemplate( $parser, Lister $lister, $dplNr, $article, $defaultTemplate, $mustMatch, $mustNotMatch, $matchParsed, $catlist ) {
